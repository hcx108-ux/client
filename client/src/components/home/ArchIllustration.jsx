    ...
    <div className={`arch-illustration-container ${className}`}>
      ...
      >
        ...
        <mask id="masterArchMask" style={{ maskType: "alpha" }} maskUnits="userSpaceOnUse" x="82" y="0" width="330" height="359">
          <path d="M274.201 0C350.274 4.38323e-05 411.943 50.883 411.943 113.65V358.3H82.3594V113.65C82.3594 50.883 144.029 6.35484e-05 220.101 0H274.201Z" fill="url(#archMaskAlphaGradient)"/>
        </mask>
        ...
        {/* Left Branch Group (Stem & Leaves) */}
        <g className="branch-group branch-left">
          {/* Left Branch Stem */}
        ...
        {/* Right Branch Group (Stem & Leaves) */}
        <g className="branch-group branch-right">
          {/* Right Branch Stem */}
        ...
        {/* Gradients */}
        <defs>
          <linearGradient id="archMaskAlphaGradient" x1="247.15" y1="277.611" x2="247.15" y2="358.3" gradientUnits="userSpaceOnUse">
